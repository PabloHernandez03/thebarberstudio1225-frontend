    ...
    <div className="font-sans text-negro-barber">
      ...
      <section className="min-h-screen flex flex-col justify-center items-center text-center px-4 bg-beige text-negro-barber">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <a href="#servicios" className="border-3 border-marron hover:bg-marron text-marron hover:text-beige px-8 py-4 rounded-full font-extrabold text-lg transition-all shadow-lg shadow-beige/20">
            Agendar mi cita
          </a>
          <Link to="/portafolio" className="border-3 border-marron hover:bg-marron text-marron hover:text-beige px-8 py-4 rounded-full font-extrabold text-lg transition-all shadow-lg shadow-beige/20">
            Portafolio
          </Link>
        </div>

        <div className="mt-4 gap-4 flex flex-col sm:flex-row">
          <a href="#productos" className="border border-beige text-marron hover:bg-marron hover:text-beige px-4 py-2 rounded-full font-bold transition-all">
            Productos
          </a>
          <a href="#blog" className="border border-beige text-marron hover:bg-marron hover:text-beige px-4 py-2 rounded-full font-bold transition-all">
            Consejos
          </a>
        </div>
      </section>
      ...
      <section id="productos" className="py-20 bg-white px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16 mx-2 sm:mx-10 md:mx-20">
            <div className="flex items-center justify-center gap-4">
              <span className="flex-1 h-1 bg-negro-suave max-w-80px md:max-w-120px"></span>
      ...
      {/* 3.5 SECCIÓN DE BLOG (VISTA PREVIA PARA GOOGLE) */}
      <section id="blog" className="py-20 bg-gray-50 px-4 border-t border-gray-100">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16 mx-2 sm:mx-10 md:mx-20">
            <div className="flex items-center justify-center gap-4">
              <span className="flex-1 h-1 bg-negro-suave max-w-80px md:max-w-120px"></span>
              <h2 className="text-xl md:text-4xl font-extrabold text-negro-barber uppercase tracking-tight whitespace-nowrap flex items-center gap-3">
                Consejos de Estilo
              </h2>
              <span className="flex-1 h-1 bg-negro-suave max-w-80px md:max-w-120px"></span>
            </div>
          ...
          <div className="flex flex-wrap justify-center gap-8">
            {ARTICULOS_BLOG.slice(0, 3).map((art) => (
              <div 
                key={art.id} 
              ...
              >
                ...
                <div className="p-6 flex flex-col grow">
                  ...
                  <Link 
                    to={`/blog/${art.id}`}
                    className="w-full text-center py-3 bg-gray-50 hover:bg-marron text-marron hover:text-white rounded-xl font-black text-xs uppercase tracking-widest transition-colors flex items-center justify-center gap-2 border border-gray-100 hover:border-marron"
                  >
          ...
          <div className="text-center mt-12">
            <Link to="/blog" className="inline-block bg-negro-barber text-dorado px-8 py-4 rounded-xl font-black text-xs uppercase tracking-widest hover:bg-dorado hover:text-negro-barber transition-all shadow-md">
